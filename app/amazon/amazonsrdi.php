<div class="container">
  <div class="py-5 text-center">
    ...
    <p class="lead">Cette solution développée par SRDi permet de faire de l'<b>Export/Import</b> des données sur la <b>MarketPlace Amazon</b></p>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <div class="py-5 text-center">
          <img class="d-block mx-auto mb-4" src="assets/img/amazon.png" style="width: 300px; height: 175px; margin-top:-100px;" alt="">
      </div>
